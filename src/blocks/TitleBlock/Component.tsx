...
export const TitleBlock: React.FC<TitleBlockProps> = ({ title }) => {
  return (
    <div className="py-8 md:py-12 lg:py-16 px-4 md:px-8 lg:px-16 xl:px-24 bg-white mx-0 w-full">
      <div className="max-w-7xl mx-auto">
        <div className="w-full sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12">
          <h2 className="text-3xl md:text-4xl text-black lg:text-5xl font-bold leading-tight">
            {title}
          </h2>
        </div>
      </div>
